...
export default function RelatedProducts() {
  return (
    <div className='related-products flex flex-col items-center gap-2'>
      <h1 className='text-[#171717] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold'>Related Products</h1>
      <hr className='w-32 h-[4px] md:w-52 lg:h-[6px] rounded-xl bg-[#252525]' />
